...
@cds.persistence.exists
entity CV_GETSCHOOLOFFERS(IP_LAT : Double, IP_LON : Double, PROXIMITY_FILTER : Integer) {
    key ID                        : String(36)           @title : 'ID';
        TIMEFROM                  : Time null            @title : 'TIMEFROM: TIMEFROM';
        TIMETO                    : Time null            @title : 'TIMETO: TIMETO';
        AVAILABLEMON              : Boolean null         @title : 'AVAILABLEMON: AVAILABLEMON';
...
@cds.persistence.exists
entity CV_GETSCHOOLOFFERS_TYPE(IP_LAT : Double, IP_LON : Double, PROXIMITY_FILTER : Integer, IP_ASSISTANCETYPE_ID : String(5000)) {
    key ID                        : String(36)           @title : 'ID';
        TIMEFROM                  : Time null            @title : 'TIMEFROM: TIMEFROM';
        TIMETO                    : Time null            @title : 'TIMETO: TIMETO';
        AVAILABLEMON              : Boolean null         @title : 'AVAILABLEMON: AVAILABLEMON';
