sap.ui.define(["jquery.sap.global", "sap/ui/core/Control", "sap/ui/core/ResizeHandler", "google.maps", "./MapsApi", "./MapUtils", "./MapTypeId"],
  function (jQuery, Control, ResizeHandler, Gmaps, MapsApi, MapUtils, MapTypeId) {
        ...
        properties: {
          ...
          zoomControl: {
            ...
            defaultValue: false
					...
					/**
					 * If true, allow native the popups on landmarks
					 */
          clickableIcons: {
            type: "boolean",
            defaultValue: true
    ...
    Map.prototype.setClickableIcons = function (bValue) {
      this.setProperty("clickableIcons", bValue, true);
      if (this.map && bValue !== this.map.clickableIcons) {
        this.map.clickableIcons = bValue;
      }
    ...
    Map.prototype.setZoomControlPosition = function (sValue) {
      this.setProperty("zoomControlPosition", sValue, true);
      if (this.map && sValue !== this.map.zoomControlOptions.position) {
        this.map.zoomControlOptions = { position: sValue };
      }
    ...
    Map.prototype._getMapOptions = function () {
      ...
      mapOptions.zoomControlOptions = { position: this.getZoomControlPosition() };
      mapOptions.mapTypeControl = this.getMapTypeControl();
      mapOptions.streetViewControl = this.getStreetViewControl();
      mapOptions.clickableIcons = this.getClickableIcons();
      return mapOptions;
    };
